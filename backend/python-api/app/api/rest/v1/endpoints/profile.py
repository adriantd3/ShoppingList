...
async def get_profile(context: AuthenticatedContextDep) -> ProfileResponse:
    return await get_profile_for_user(db=context.db, principal=context.principal)
...
async def patch_profile(
    ...
    return await update_profile_for_user(
        db=context.db,
...
async def get_notification_preferences(
    ...
    return await get_notification_preferences_for_user(db=context.db, principal=context.principal)
...
async def patch_notification_preferences(
    ...
    return await update_notification_preferences_for_user(
        db=context.db,
        principal=context.principal,
        payload=payload,
    )
...
async def register_push_token(
    ...
    return await register_push_token_for_user(
        db=context.db,
        principal=context.principal,
        payload=payload,
    )
